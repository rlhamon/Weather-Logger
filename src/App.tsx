  ...
  const executeQuery = async (
    ...
    try {
      ...
      if (triggerAutoDownload) {
        if (useTemplate && templateFileBase64) {
          try {
    ...
    <div className="min-h-screen bg-slate-50 font-sans text-slate-900 flex flex-col antialiased">
        ...
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-lg font-bold tracking-tight text-slate-800 uppercase flex items-center gap-2">
              NOAA Data Archiver <span className="bg-indigo-100 text-indigo-700 text-[10px] font-bold px-2 py-0.5 rounded-full uppercase">v2.4</span>
            </h1>
      ...
      <main className="flex-1 p-4 sm:p-8 max-w-7xl w-full mx-auto grid grid-cols-12 gap-6 print:block print:p-0">
        ...
        <aside className="col-span-12 lg:col-span-4 xl:col-span-3 flex flex-col gap-6">
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full p-3 pl-4 bg-slate-50 border border-slate-200 rounded-xl text-sm font-mono font-semibold focus:ring-2 focus:ring-indigo-500/20 focus:border-indigo-500 focus:bg-white outline-hidden transition-all text-slate-800"
                  />
                  <button
                    type="submit"
                    disabled={loading}
                    id="submit-zipcode-btn"
                    className="absolute right-2.5 top-2.5 bg-indigo-600 text-white p-1.5 rounded-lg hover:bg-indigo-700 hover:scale-105 active:scale-95 disabled:opacity-50 transition-all cursor-pointer"
            ...
            <div className={`space-y-3 pt-2 border-t border-slate-100 transition-opacity ${selectedPreset === 'custom' ? 'opacity-100' : 'opacity-70'}`}>
              <div>
                ...
                <input
                  ...
                  className="w-full p-2.5 bg-slate-50 border border-slate-200 rounded-lg text-sm font-semibold focus:outline-hidden focus:ring-1 focus:ring-indigo-500"
                />
              </div>
              <div>
          ...
          <div className="bg-indigo-950 p-5 rounded-2xl text-white shadow-md shadow-indigo-950/20">
            <h3 className="font-bold text-sm mb-4 tracking-tight uppercase border-b border-indigo-900 pb-2 text-indigo-200 flex items-center gap-2">
            ...
            <div className="space-y-4">
              ...
              <div>
                <span className="text-[10px] text-indigo-300 block mb-1.5 uppercase font-bold tracking-wider">Atmospheric Scale</span>
                <div className="flex bg-indigo-900/50 p-1 rounded-lg">
                  <button
                    ...
                    className={`flex-1 text-center py-1.5 text-xs font-bold rounded-md transition-all ${
                      unit === 'F' ? 'bg-indigo-600 text-white shadow-xs' : 'text-indigo-200 hover:text-white'
                    }`}
                  >
                    Fahrenheit (°F)
                  </button>
                  <button
                    ...
                    className={`flex-1 text-center py-1.5 text-xs font-bold rounded-md transition-all ${
                      unit === 'C' ? 'bg-indigo-600 text-white shadow-xs' : 'text-indigo-200 hover:text-white'
                    }`}
                  >
                    Celsius (°C)
                  </button>
              ...
              <div className="pt-2 border-t border-indigo-900/60">
                <label className="flex items-start gap-3 text-xs select-none cursor-pointer">
                  <input 
                    ...
                    className="mt-0.5 accent-indigo-400 h-4 w-4 rounded-sm border-indigo-900"
                  />
                  <div>
                    <span className="font-bold text-indigo-100 block">Auto-Download Spreadsheet</span>
                    <span className="text-[10px] text-indigo-300 leading-tight block mt-0.5">Automatically trigger downloading Excel workbook upon completing fetch.</span>
                  </div>
                </label>
              </div>
            </div>
            ...
            <div className="space-y-4">
              ...
              <div className="p-3 bg-slate-50 rounded-xl border border-slate-100 flex flex-col gap-1.5">
                ...
                <div className="flex items-center gap-1.5 mt-0.5 pt-1.5 border-t border-slate-200/60">
                  ...
                  <span className="text-[10px] font-mono font-bold text-indigo-600 bg-indigo-50 px-1.5 py-0.5 rounded-sm">
              ...
              <label className="flex items-start gap-3 text-xs select-none cursor-pointer">
                <input 
                  ...
                  className="mt-0.5 accent-indigo-600 h-4 w-4 rounded-sm border-slate-300"
                />
                <div>
              ...
              <button
                ...
                className="w-full py-2 bg-indigo-50 hover:bg-indigo-100/80 hover:text-indigo-700 text-indigo-600 text-xs font-bold rounded-xl mt-1.5 active:scale-98 transition-all flex items-center justify-center gap-1.5 cursor-pointer border border-indigo-100 shadow-2xs"
          ...
          <div className="bg-white border border-slate-200 p-5 rounded-2xl shadow-xs print:hidden">
            <h3 className="text-slate-800 font-bold text-sm tracking-tight mb-3 flex items-center justify-between">
              ...
              <span className="text-[9px] uppercase font-bold px-2 py-0.5 rounded-full bg-slate-100 text-indigo-600 font-mono">
                Logger Sync
              </span>
            </h3>
              ...
              {useTemplate && (
                <div className="pt-3 border-t border-slate-100 space-y-4">
                  ...
                  <div>
                    ...
                    {templateFileBase64 ? (
                      <div className="p-2.5 bg-indigo-50/40 border border-indigo-100 rounded-xl flex items-center justify-between gap-1.5">
                        <div className="min-w-0 flex-1">
                          ...
                          <span className="text-[9px] text-indigo-600 font-bold flex items-center gap-1 mt-0.5">
                            <CheckCircle2 className="h-3 w-3 shrink-0 text-indigo-500" />
                      ...
                      <div className="relative border-2 border-dashed border-slate-200 rounded-xl hover:border-indigo-400 hover:bg-indigo-50/20 transition-all p-4 text-center cursor-pointer">
                        <input
                          type="file"
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    ...
                    <div>
                      ...
                      <input 
                        ...
                        min="1"
                        className="w-full text-xs bg-slate-50 border border-slate-200 rounded-lg px-2.5 py-1.5 focus:bg-white focus:outline-hidden focus:ring-1 focus:ring-indigo-500 font-mono font-bold"
                      />
                    </div>
                  </div>
                      ...
                      {[
                        ...
                        <div key={key} className="flex items-center justify-between gap-1.5 border-b border-slate-200/50 pb-1.5 last:border-0 last:pb-0">
                          ...
                          <input 
                            ...
                            placeholder="None"
                            className="w-12 text-center text-xs bg-white border border-slate-200 rounded-md py-0.5 px-1 font-mono font-bold text-indigo-600 focus:outline-hidden focus:ring-1 focus:ring-indigo-500 uppercase"
                            maxLength={3}
                          />
                        </div>
                      ))}
          ...
          <div className="bg-slate-900 text-slate-300 p-5 rounded-2xl border border-slate-800 font-mono text-[10px] shadow-sm">
            <div className="flex justify-between items-center mb-2.5 border-b border-slate-800 pb-2">
              <span className="text-[9px] uppercase font-bold tracking-wider text-indigo-400">Atmospheric Data Terminal</span>
          ...
          {loading ? (
            <div className="bg-white border border-slate-200 rounded-2xl p-16 flex flex-col items-center justify-center text-center shadow-xs">
              <div className="relative flex items-center justify-center">
                ...
                <CloudRain className="absolute h-5 w-5 text-indigo-600 animate-bounce" />
              </div>
              ...
              <div id="noaa-print-header" className="hidden print:block border-b-2 border-slate-800 pb-4 mb-6">
                <div className="flex justify-between items-end">
                  ...
                  <div className="text-right">
                    <p className="text-xs font-bold text-indigo-700 bg-indigo-50 px-2 py-0.5 rounded-sm inline-block uppercase">PRESET: {selectedPreset}</p>
                ...
                <div className="flex items-center justify-between border-b border-slate-100 pb-3">
                  ...
                  <div className="flex items-center gap-2">
                    <button
                      ...
                      className="px-2.5 py-1 text-[10px] font-bold uppercase rounded-lg border border-slate-200 bg-slate-50 text-slate-500 hover:text-indigo-600 hover:bg-slate-100 hover:border-indigo-200 active:scale-95 transition-all flex items-center gap-1.5 cursor-pointer shadow-2xs"
                ...
                <div className="flex flex-col sm:flex-row items-stretch sm:items-center gap-2 w-full md:w-auto">
                  ...
                  <div className="relative flex-1 sm:flex-none">
                    <select
                      ...
                      className="w-full sm:w-auto appearance-none bg-white border border-slate-200 text-slate-700 text-xs font-bold pl-4 pr-10 py-2.5 rounded-xl hover:border-slate-300 focus:outline-hidden focus:ring-2 focus:ring-indigo-500/20 cursor-pointer uppercase tracking-wider"
                  ...
                  <button
                    ...
                    className="flex-1 sm:flex-none px-6 py-2.5 bg-indigo-600 text-white rounded-xl text-xs font-bold shadow-lg shadow-indigo-100 hover:bg-indigo-700 hover:scale-[1.01] active:scale-99 transition-all flex items-center justify-center gap-2 uppercase tracking-wider cursor-pointer font-semibold shrink-0"
                  >
          ...
          <div className="bg-slate-100 border border-slate-200 rounded-2xl p-5 flex items-start gap-4 print:hidden">
            ...
            <div className="text-xs leading-relaxed text-slate-600 font-medium">
              ...
              <ul className="list-disc list-inside space-y-1">
                <li>On start/refresh, previous day hour-to-hour records download automatically for <span className="font-bold text-indigo-600">{location?.cityName || 'ZIP 90210'}</span>.</li>
